...
import '../functions/db_favourite.dart';
import '../functions/db_playlist.dart';
import '../functions/db_playlist_video.dart';
          ...
          Expanded(
            child: ValueListenableBuilder(
                ...
                builder: ((BuildContext context,
                    List<PlaylistVideoModel> playlistvideo, child) {
                  return ListView.builder(
                    itemCount: playlistvideo.length,
                    itemBuilder: ((_, int index) {
                      if (playlistvideo[index].playlistId ==
                          widget.playlistID) {
                                                    ...
                                                    SimpleDialogOption(
                                                      padding:
                                                          const EdgeInsets.all(
                                                              8),
                                                      onPressed: (() {
                                                        if (videoFound.isFavourite ==
                                                            true) {
                                                          deleteFromFavouritesUsingPath(
                                                              data.path);

                                                          
                                                          videoFound.isFavourite =
                                                              false;
                                                          videoBox.put(
                                                              videoFound.id, videoFound);
                                                          ...
                                                          SnackBar(
                                                            backgroundColor:
                                                                const Color
                                                                    ...
                                                                    38),
                                                            content: Text(
                                                              '$title is removed from ${widget.name}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
                                                              style: TextStyle(
